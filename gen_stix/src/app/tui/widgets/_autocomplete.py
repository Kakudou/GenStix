    ...
    def __rich_console__(
        ...
        for index, match in enumerate(self.matches):
            ...
            if index == self.selection_cursor_index:
                additional_row_style = self.component_styles[
                    "selection-cursor"
                ]
...
AutoComplete {
    ...
    def __init__(
        ...
        *,
        ...
        self.title = f"{title}{'' if not self.required else '(Required)'}"
        self.tooltip_text = f""" # {self.title}
---
...
{tooltip_text}"""
    ...
    def on_mount(self) -> None:
        self.input.border_title = self.title
        self.input.styles.border_title_align = "left"
        self.input.styles.border_title_background = (
            self.app.screen.styles.background
        )
