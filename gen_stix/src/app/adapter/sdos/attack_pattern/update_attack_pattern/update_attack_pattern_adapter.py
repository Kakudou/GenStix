""" This module use the usecase UpdateAttackPattern"""
...
class UpdateAttackPatternAdapter:
    """This class gonna take the input, sanitize and give it to the usecase.

    Functions:
    ----------
    execute: staticmethod
        will consume the usecase UpdateAttackPattern.

    """

    @staticmethod
    def execute(inputs: Dict, storage_engine=STORAGE_ENGINE):
        """This function will convert inputs into UpdateAttackPatternInputPort
        with the use of UpdateAttackPatternInputPortBuilder.
        Then this contract will be gave to UpdateAttackPattern usecase.
        In return we should obtain the contract UpdateAttackPatternOutputPort
        ...
        Returns:
        --------
        UpdateAttackPattern_oc
            the output contract of the usecase UpdateAttackPattern
        ...
        update_attack_pattern_icb = UpdateAttackPatternInputPortBuilder()
        update_attack_pattern_ic = (
            update_attack_pattern_icb.create()
        ...
        update_attack_pattern_oc = Container.get_usecase_repo(
            "UpdateAttackPattern", storage_engine
        ).execute(update_attack_pattern_ic)

        return update_attack_pattern_oc
