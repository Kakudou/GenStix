"""This module is the AttackPattern that will be shown"""
...
class AttackPatternView:
    ...
    def from_contract(contract):
        attack_pattern = AttackPatternView()
        attack_pattern.type_ = contract.type_
        attack_pattern.external_references = contract.external_references
        attack_pattern.name = contract.name
        attack_pattern.description = contract.description
        attack_pattern.aliases = contract.aliases
        attack_pattern.kill_chain_phases = contract.kill_chain_phases
