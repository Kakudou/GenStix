...
from gen_stix.src.gen_stix.usecase.\
    cdts.external_reference.update_external_reference.update_external_reference_inputport\
    import UpdateExternalReferenceInputPort
from gen_stix.src.gen_stix.usecase.\
    cdts.external_reference.update_external_reference.update_external_reference_outputport_builder\
    import UpdateExternalReferenceOutputPortBuilder
from gen_stix.src.gen_stix.usecase.\
...
class UpdateExternalReference:
    ...
    def execute(self, inputp: UpdateExternalReferenceInputPort) -> UpdateExternalReferenceOutputPort:
        ...
        if external_reference is None:
            error = "The ExternalReference you want, doesn't look like to exist"
            ...
            executed = self.gateway.update_by_identifier(identifier, external_reference)
