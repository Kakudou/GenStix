...
@dataclass
class CreateKillChainPhaseInputPortBuilder:
    """This class defined the function to easily build the input contract

    Attributes:
    -----------
    __input: CreateKillChainPhaseInputPort
        the input contract
    ...
    def create(self):
        ...
        self.__input = CreateKillChainPhaseInputPort()
        return self
    ...
    def build(self) -> CreateKillChainPhaseInputPort:
