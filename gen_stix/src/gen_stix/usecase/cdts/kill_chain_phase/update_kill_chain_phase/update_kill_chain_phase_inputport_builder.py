...
@dataclass
class UpdateKillChainPhaseInputPortBuilder:
    """This class defined the function to easily build the input contract

    Attributes:
    -----------
    __input: UpdateKillChainPhaseInputPort
        the input contract
    ...
    def create(self):
        ...
        self.__input = UpdateKillChainPhaseInputPort()
        return self
    ...
    def build(self) -> UpdateKillChainPhaseInputPort:
