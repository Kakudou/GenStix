...
@given(parsers.parse("An AttackPattern is created with a {type_}, {name}, and invalid {aliases}."), target_fixture="context")
...
@then(parsers.parse("A TypeError should be raised, stating that {aliases} should be a list of strings."))
