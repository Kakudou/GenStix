...
def when_attack_pattern_stix21_constraint_kill_chain_phases(context):
    kill_chain_phases = {}
    try:
        kill_chain_phases = json.loads(context["kill_chain_phases"])
    except json.JSONDecodeError:
        pass
    try:
        context["input_contract"].with_kill_chain_phases(kill_chain_phases)
