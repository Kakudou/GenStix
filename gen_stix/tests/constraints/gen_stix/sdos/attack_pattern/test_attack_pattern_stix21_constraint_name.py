...
@given(parsers.parse("An AttackPattern is created with a {name} that is not a string and a valid {type_}."), target_fixture="context")
...
@then(parsers.parse("A TypeError should be raised, stating that the value of name must be a string."))
